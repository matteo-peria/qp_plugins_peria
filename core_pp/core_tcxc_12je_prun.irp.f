BEGIN_PROVIDER [ double precision, core_tcxc_grid12je_prun, (ao_num, ao_num, ao_num, ao_num)]
  implicit none
  BEGIN_DOC
  ...
  do i1 = 1, n_points_final_grid
    ...
    do i2 = 1, n_points_final_grid2
      ...
      do j = 1, ao_num
        ...
        ! MAYBE WE CAN PUT THE FOLLOWING 3 DO-LOOP INSIDE THE I2P LOOP?
        ...
        do l = 1, ao_num
          ...
          do k = 1, ao_num
            ...
            do i = 1, ao_num
              ...
              core_tcxc_grid12je_prun(i,k,l,j) += w1 * ao_i_r1 * ao_k_r1 * w2 * j_r1r2 * ao_l_r2 * integral
            enddo ! loop i
          enddo  ! loop k
        enddo  ! loop l
