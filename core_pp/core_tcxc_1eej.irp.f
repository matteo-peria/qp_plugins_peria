 BEGIN_PROVIDER [ double precision, core_tcxc_grid1eej, (ao_num, ao_num, ao_num, ao_num)]
  implicit none
  BEGIN_DOC
            ...
            do l = 1, ao_num
              ...
              do k = 1, ao_num
                ...
                do i = 1, ao_num
                  ...
                  core_tcxc_grid1eej(i,k,l,j) += w1 * ao_i_r1 * ao_k_r1 * w2 * j_r1r2 * ao_l_r2 * integral_j_r2p
                enddo
              enddo
            enddo
