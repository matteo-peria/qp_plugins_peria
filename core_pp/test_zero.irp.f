program test_zero
 ...
 allocate(grid_points(3,n_points_angular_grid_adapt,n_points_radial_grid_adapt,nucl_num+1))
 allocate(weights_points(n_points_angular_grid_adapt,n_points_radial_grid_adapt,nucl_num+1))
 r_gauss = 0.d0
 alpha = 1.d0 
 r_input = 0.D0
 r_input(1) = 0.5d0
