 ...
 subroutine get_adaptive_grid_becke_weights_grid2( rp, float_grid, fixed_grid      &
  ...
  double precision, intent(out):: becke_weights_at_fixed_grid(n_points_ang_grid2, n_points_rad_grid2, nucl_num)
  integer :: i_nucl,k,l
  !
...
subroutine get_becke_functions_general_grid2(r, rp, slater_inter_per_input, n_weights, weights)
 implicit none
 BEGIN_DOC
 !
 ...
 !
 double precision :: cell_function_becke_extra_atom_grid2
 double precision :: cell_function_becke_general_adapt_grid2
 integer :: i
...
!!   fixed_grid_start = 2
   ...
   weights(1) = cell_function_becke_extra_atom_grid2(r, rp, slater_inter_per_input)
 ...
 !do i = fixed_grid_start, nucl_num
   ...
   weights(i+1) = cell_function_becke_general_adapt_grid2(r, i, rp, slater_inter_per_input) 
   !weights(i) = cell_function_becke_general_adapt_grid2(r, i-1, rp, slater_inter_per_input) 
 enddo
...
double precision function cell_function_becke_extra_atom_grid2(r, rp, slater_inter_perp)
  BEGIN_DOC
  ! 
  ...
  cell_function_becke_extra_atom_grid2 = 1.d0
  ...
  do j = 1, nucl_num
    ...
    cell_function_becke_extra_atom_grid2 *= step_function_becke(nu_ij)
    !
    !write(*,'(I4,100E13.4)'), j, r_j, R_ij, mu_ij, nu_ij, cell_function_becke_extra_atom_grid2
  enddo
  return
end function


double precision function cell_function_becke_general_adapt_grid2(r                       &
                                                            , atom_number            &
                                                            , rp                     &
                                                            , slater_inter_per_input &
                                                            )
  ...
  cell_function_becke_general_adapt_grid2 = 1.d0
  ...
  do j = 1, nucl_num
    ...
    ! Update Becke-weight with j-th atom contribution
    cell_function_becke_general_adapt_grid2 *= step_function_becke(nu_ij)
    !write(*,'(I4,100E13.4)'), j, r_j, mu_ij, nu_ij, cell_function_becke_general_adapt_grid2
  enddo
  ...
  if (silence_floating_grid.eq..false.) then
    ...
    !!write(*,'(100E13.4)'), r_j, mu_ij, nu_ij, cell_function_becke_general_adapt_grid2
  end if
