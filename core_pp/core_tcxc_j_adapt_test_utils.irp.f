BEGIN_PROVIDER [ double precision, core_xpot_adapt_grid2ja, (ao_num, ao_num)]
  implicit none
  BEGIN_DOC
  ...
  do i2 = 1, n_points_final_grid2
    ...
    do j = 1, ao_num
      ...
      do l = 1, ao_num
        ...
        core_xpot_adapt_grid2ja(l,j) += w2 * ao_l_r2 * integral
      enddo
...
BEGIN_PROVIDER [ double precision, core_tcxc_adapt_j0_grid12ja, (ao_num, ao_num, ao_num, ao_num)]
  implicit none
  BEGIN_DOC
  ! TEST-ONLY PROVIDER.
  ...
  ! Initialization
  core_tcxc_adapt_j0_grid12ja(:,:,:,:) = 0.d0
  ...
  do j = 1, ao_num
    do l = 1, ao_num
      do k = 1, ao_num
        do i = 1, ao_num
          core_tcxc_adapt_j0_grid12ja(i,k,l,j) = ao_overlap_grid1(i,k) * core_xpot_adapt_grid2ja(j,l)
        end do
      end do
    end do
  end do
